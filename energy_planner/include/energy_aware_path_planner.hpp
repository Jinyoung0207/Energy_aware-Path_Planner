...
{
public:
    explicit EnergyPathPlanner(ros::NodeHandle& nh);
    ...
    geometry_msgs::Point gridToWorld(const GridIdx& idx) const;
...
{
public:
    PlanningManager(ros::NodeHandle& nh, ros::NodeHandle& pnh);
