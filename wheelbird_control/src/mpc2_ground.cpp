...
void mpc_ugv::init()
{
    mode_flag_sub = nh_.subscribe<std_msgs::Int64>("/wheelbird2/mode_flag", 1, &mpc_ugv::controller_mode_num_Callback, this);
    rbt_odom_sub = nh_.subscribe<geometry_msgs::PoseStamped>("/wheelbird2/mavros/local_position/pose", 1, &mpc_ugv::rbt_odom_Callbck, this);
    rbt_vel_sub = nh_.subscribe<geometry_msgs::TwistStamped>("/wheelbird2/mavros/local_position/velocity_local", 1, &mpc_ugv::rbt_vel_Callbck, this);
    rbt_ref_traj_sub = nh_.subscribe<nav_msgs::Path>("/wheelbird2/local_path", 1, &mpc_ugv::rbt_ref_traj_Callbck, this);
    ...
    attitude_pub = nh_.advertise<mavros_msgs::AttitudeTarget>("/wheelbird2/mavros/setpoint_raw/attitude", 1);
}
